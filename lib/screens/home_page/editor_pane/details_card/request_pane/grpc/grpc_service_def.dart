...
class GrpcServiceDef extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    if (connectionState == null || connectionState.descriptors == null || connectionState.descriptors!.isEmpty) {
      return Center(
        child: Padding(
          padding: kPh20,
          child: Column(
          ...
          return Padding(
            ...
            child: Theme(
              ...
              child: ExpansionTile(
                ...
                subtitle: Text("${methods.length} methods", style: Theme.of(context).textTheme.bodySmall),
                  ...
                  return InkWell(
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Icon(_getMethodIcon(mType), size: 16, color: Theme.of(context).colorScheme.primary),
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Wrap(
                                  children: [
                                    Text("$mType • ", style: Theme.of(context).textTheme.bodySmall),
                                    Text(mInput, style: Theme.of(context).textTheme.bodySmall?.copyWith(fontFamily: 'monospace')),
                                    Text(" → ", style: Theme.of(context).textTheme.bodySmall),
                                    Text(mOutput, style: Theme.of(context).textTheme.bodySmall?.copyWith(fontFamily: 'monospace')),
                                  ]
                                )
                              ],
                            ),
                          ...
                          Flexible(
                            child: Text(
                              mPath,
                              style: Theme.of(context).textTheme.bodySmall?.copyWith(fontFamily: 'monospace', color: Theme.of(context).colorScheme.onSurfaceVariant.withValues(alpha: 0.7)),
