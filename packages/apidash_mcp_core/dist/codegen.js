...
export function generateCurl(input) {
    const { method, url, headers, body } = input;
    const lines = [`curl -X ${method} '${sanitizeUrl(url)}'`];
...
export function generatePythonRequests(input) {
    const { method, url, headers, body } = input;
...
export function generateJavaScriptFetch(input) {
    const { method, url, headers, body } = input;
    const lines = [];
...
export function generateJavaScriptAxios(input) {
    const { method, url, headers, body } = input;
...
export function generateNodeFetch(input) {
    const { method, url, headers, body } = input;
    const lines = ['const fetch = require("node-fetch");', ''];
...
export function generateDartHttp(input) {
    const { method, url, headers, body } = input;
...
export function generateJava(input) {
    const { method, url, headers, body } = input;
    const lines = [
        'import java.net.URI;',
...
export function generateKotlin(input) {
    const { method, url, headers, body } = input;
...
export function generatePhp(input) {
    const { method, url, headers, body } = input;
    const lines = ['<?php', ''];
...
export function generateRuby(input) {
    const { method, url, headers, body } = input;
...
export function generateRust(input) {
    const { method, url, headers, body } = input;
    const lines = [
        'use reqwest;',
        '',
...
export function generateCode(generatorId, input) {
    switch (generatorId) {
