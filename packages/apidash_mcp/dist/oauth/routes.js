...
import { registerClient, getClient, createAuthCode, consumeAuthCode, createAccessToken, consumeRefreshToken, revokeToken, } from "./store.js";
const router = Router();
...
router.get("/authorize", (req, res) => {
    const { response_type, client_id, redirect_uri, code_challenge, code_challenge_method, scope = "mcp", state, } = req.query;
    ...
    if (!client.redirect_uris.includes(redirect_uri)) {
        ...
        const isValidLocal = client.redirect_uris.some((uri) => {
            ...
            return (requestedUrl.hostname === '127.0.0.1' &&
